...
public class PfCarga {
    ...
    @OneToMany(mappedBy = "pfCarga", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.EAGER)
    private List<PfDetalhe> detalhes = new ArrayList<>();
    ...
    public List<PfDetalhe> getDetalhes() { return detalhes; }
    public void setDetalhes(List<PfDetalhe> detalhes) { this.detalhes = detalhes; }

    public void addDetalhe(PfDetalhe detalhe) {
        detalhes.add(detalhe);
        detalhe.setPfCarga(this);
    }
}
